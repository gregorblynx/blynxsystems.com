...
const requiredFiles = [
  ...
  "public/images/projects/barber-demo.jpg",
  "public/images/demos/barber-hero.jpg",
  "public/images/demos/barber-tools.jpg",
  "public/images/demos/barber-cut.jpg",
  "demos/forge/index.html",
  "demos/forge/es/index.html",
  "demos/barber/index.html",
  "demos/barber/es/index.html",
...
const requiredSnippets = new Map([
  ...
  ["en/index.html", [
    "Get found.",
    "Get contacted.",
    "blynx-before-after-en",
    "Three systems. Choose how far yours goes.",
    "Digital Presence System",
    "Customer Requests & Organization System",
    "Customer Requests & Follow-Up System",
    "What's included",
    "Best Value",
    "Starting at",
    "$1,500",
    ...
    "They find you",
    "Three steps. One milestone each.",
    "50% to begin",
    "$650",
    "+$850",
    "data-stage-banner",
  ...
  ["es/index.html", [
    ...
    "Cinco partes. Un solo sistema conectado.",
    "CÓMO FUNCIONA — RECORRIDO DEL CLIENTE",
    "Te encuentran",
    "Tres pasos. Un hito cada uno.",
    "50% para comenzar",
    "$650",
    "+$850",
    "data-stage-banner",
  ...
  ["es/free-audit/index.html", [
    ...
    "Cómo Funciona la Auditoría Gratis",
  ...
  ["en/services/index.html", [
    ...
    "Customer Requests & Organization System",
    "Customer Requests & Follow-Up System",
    "Everything in the Digital Presence System, plus:",
    "Not included",
  ...
  ["es/services/index.html", [
    ...
    "No incluye",
    "Mantenimiento del Sistema Digital",
