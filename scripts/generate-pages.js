...
// Source PNGs live in assets/images/; responsive AVIF/WebP/PNG derivatives at
// 480/800/1200/1672w are generated by scripts/optimize-images.js and are not
// regenerated by the page build.
const PRODUCT_IMAGES = {
  hero: {
    base: "blynx-connected-system-hero",
    width: 1672,
    height: 941,
    alt: {
      en: "The BLYNX connected system: a business listing, website, inquiry form and lead pipeline linked into one automatic follow-up flow.",
      es: "El sistema conectado BLYNX: una ficha de negocio, sitio web, formulario de solicitud y pipeline de leads enlazados en un flujo de seguimiento automático."
    }
  },
  system1: {
    base: "blynx-system-1-digital-presence",
    width: 1672,
    height: 941,
    alt: {
  ...
  system2: {
    base: "blynx-system-2-capture-organization",
    width: 1672,
    height: 941,
    alt: {
...
function productImage(key, lang, { priority = false, sizes = "(max-width: 760px) 100vw, 800px", className = "" } = {}) {
  ...
  const base = `/assets/images/${img.base}`;
  ...
  return `
            <div class="product-visual${className ? " " + className : ""}">
              <picture>
                ...
                <img src="${base}-1200-fallback.png" width="${img.width}" height="${img.height}" alt="${img.alt[lang]}" loading="${priority ? "eager" : "lazy"}" decoding="async"${priority ? ' fetchpriority="high"' : ""}>
              </picture>
            </div>`;
}
